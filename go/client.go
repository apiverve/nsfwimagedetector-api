// Package nsfwimagedetector provides a Go client for the NSFW Image Detector API.
//
// For more information, visit: https://apiverve.com/marketplace/nsfwimagedetector?utm_source=go&utm_medium=readme
package nsfwimagedetector
...
const (
	baseURL        = "https://api.apiverve.com/v1/nsfwimagedetector"
	defaultTimeout = 30 * time.Second
)

// Client is the NSFW Image Detector API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new NSFW Image Detector API client.
...
// ExecuteWithFile makes a request to the NSFW Image Detector API with a file upload.
...
// Execute makes a request to the NSFW Image Detector API with typed parameters.
//
...
//   - image: string - Upload an image file containing the image needing classification (supported formats: JPG, PNG, GIF)
