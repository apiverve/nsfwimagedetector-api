# NSFW Image Detector API - Examples

This folder contains example code for using the NSFW Image Detector API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/nsfwimagedetector',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/nsfwimagedetector");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/nsfwimagedetector](https://docs.apiverve.com/ref/nsfwimagedetector)
