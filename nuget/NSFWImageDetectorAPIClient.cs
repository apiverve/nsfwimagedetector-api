...
namespace APIVerve.API.NSFWImageDetector
{
    ...
    /// <summary>
    /// Client for the NSFWImageDetector API
    /// </summary>
    public class NSFWImageDetectorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/nsfwimagedetector";
        ...
        public NSFWImageDetectorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public NSFWImageDetectorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public NSFWImageDetectorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, NSFWImageDetectorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(NSFWImageDetectorQueryOptions options)
        {
        ...
        public ResponseObj Execute(NSFWImageDetectorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(NSFWImageDetectorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(NSFWImageDetectorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(NSFWImageDetectorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(NSFWImageDetectorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(NSFWImageDetectorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(NSFWImageDetectorQueryOptions options)
        {
